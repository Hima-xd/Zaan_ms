...
from KRISTY import OWNER_USERNAME, BOT_NAME
from KRISTY import arq
from KRISTY.services.keyboard import Ikb
from KRISTY.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from KRISTY.services.tasks import _get_tasks_text, all_tasks, rm_task
from KRISTY.services.types import InlineQueryResultCachedDocument
from KRISTY.modules.info import get_chat_info, get_user_info
from KRISTY.modules.music import download_youtube_audio
from KRISTY.utils.functions import test_speedtest
from KRISTY.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/8a854e8107aba09e0d661.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/MISS_KRISTY_BOT"),
        InlineKeyboardButton(
    ...
    msg = f"""
**Developer:**[KRISTY](https://t.me/KRISTY_AF)
**Owner:**[{BOT_NAME}](https://t.me/{OWNER_USERNAME})
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [ALONE](t.me/i_am_pro_king)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
